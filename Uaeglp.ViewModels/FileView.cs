    ...
    public class FileView
    {
        ...
        public string NameWithExtension
        {
            get
            {
                ...
                if (this.postedFiles == null || this.postedFiles.Count() == 0)
                {
                    this._nameWithExtension = string.Empty;
                    return this._nameWithExtension;
                }
                this._nameWithExtension = this.postedFiles.First().FileName;
                return this._nameWithExtension;
            }
            set
            {
        ...
        public byte[] Bytes
        {
            get
            {
                ...
                var httpPostedFileBase = postedFiles.First();
                if (httpPostedFileBase != null)
                {
                    using var memoryStream = new MemoryStream();
                    httpPostedFileBase.CopyTo(memoryStream);
