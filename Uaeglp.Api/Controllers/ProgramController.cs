...
namespace Uaeglp.Api.Controllers
{
    ...
    public class ProgramController : Controller
    {
        ...
        {
            var data = await _programService.GetBatchDetailsAsync(profileId,batchId);
        ...
        public async Task<IActionResult> AddOrUpdateApplicationAnswerAsync(ProgramAnswerViewModel answerViewModel)
        {
