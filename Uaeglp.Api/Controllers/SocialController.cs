...
namespace Uaeglp.Api.Controllers
{
	...
	public class SocialController : Controller
    {
		...
		public async Task<IActionResult> AddPostAsync([FromForm] BasePostViewModel view)
		{
			if (!ModelState.IsValid)
				return BadRequest(ModelState.GetErrorMessages());
		...
		[HttpGet("posts/{postId}/comments", Name = "GetPostComment")]
		public async Task<IActionResult> GetPostCommentAsync(string postId)
		{
		...
		[HttpGet("users/{userId}/favorite-posts/", Name = "GetUserFavoritePosts")]
		public async Task<IActionResult> GetUserFavoritePostsAsync(int userId)
		{
			var result = await _service.GetPostsByUserFavoriteAsync(userId);
